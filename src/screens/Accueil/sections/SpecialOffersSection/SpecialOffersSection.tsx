...
const offerCards = [
  {
    ...
    text: "Découvrez notre gamme de meubles et d'articles de décoration",
    price: "50 000 FCFA",
    image: "/images/categories/economie1.png",
  },
  {
    bgColor: "bg-[#f9dcdc]",
    priceColor: "text-[#961f1f]",
    text: "Découvrez notre gamme de livres et d'articles éducatifs",
    price: "20 000 FCFA",
    image: "/images/categories/economie2.png",
  },
  {
    bgColor: "bg-[#f2e4d9]",
    priceColor: "text-[#94623c]",
    text: "Découvrez notre gamme de vêtements et d'articles de mode",
    price: "5 000 FCFA",
    image: "/images/categories/economie3.png",
  },
  {
    bgColor: "bg-[#d2f7ec]",
    priceColor: "text-[#003d29]",
    text: "Découvrez notre gamme de materiels et d'articles de bureau",
    price: "10 000 FCFA",
    image: "/images/categories/economie4.png",
  },
];
...
export const SpecialOffersSection = (): JSX.Element => {
  return (
    <section className="w-full py-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-[48px] cursor-pointer">
            ...
            <CardContent className="p-0 relative h-[421px]">
              <div className={`${card.bgColor} w-full h-[211px]`}>
                <div className="pt-6 px-[31px]">
                  ...
                  <div
                    className={`mt-[26px] font-semibold ${card.priceColor} text-[32px] [text-shadow:0px_2px_23px_#00000026] [font-family:'Inter',Helvetica] tracking-[0] leading-[normal]`}
                  >
                    {card.price}
                  </div>
